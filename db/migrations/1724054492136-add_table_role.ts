...
export class AddTableRole1724054492136 implements MigrationInterface {
    name = 'AddTableRole1724054492136'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`user\` CHANGE \`roles\` \`roleId\` varchar(255) NULL DEFAULT 'NULL'`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`post\` DROP FOREIGN KEY \`FK_5c1cf55c308037b5aca1038a131\``);
        await queryRunner.query(`ALTER TABLE \`user\` DROP COLUMN \`roleId\``);
        await queryRunner.query(`ALTER TABLE \`user\` ADD \`roleId\` varchar(255) NULL DEFAULT 'NULL'`);
        ...
        await queryRunner.query(`ALTER TABLE \`user\` CHANGE \`roleId\` \`roles\` varchar(255) NULL DEFAULT 'NULL'`);
    }
